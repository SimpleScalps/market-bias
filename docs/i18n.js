...
window.I18N = {
  de: {
    ...
    sortOpt: { eingang: 'Eingang', priority: 'Relevanz', time: 'Zeit', impact: 'Signalstärke' },
    ...
    frageOhneWorker: 'Nachfragen braucht den Cloudflare Worker mit hinterlegtem Schlüssel.',
    frageDu: 'Du', frageModell: 'Antwort',
    zustand: 'SYSTEMZUSTAND', zustandPruefen: 'Zustand abrufen',
    ...
    eingang: 'Eingang',
    eingangHinweis: 'Links: wann die Quelle die Meldung veröffentlicht hat. Rechts: wann sie bei uns ankam — das ist der Zeitpunkt der Discord-Meldung.',
    ...
    liveHinweis: 'Adresse des Cloudflare Workers. Leer lassen für den Standardtakt. Das Zugangswort schützt Abo und Kontingent — es muss mit dem im Worker hinterlegten übereinstimmen.',
    zugangPlatzhalter: 'Zugangswort (schützt Abo und Kontingent)', liveInaktiv: 'Standardtakt (GitHub Actions)',
    ...
    kiKorrigiert: 'durch KI-Analyse korrigiert',
    regelSagte: 'Regelwerk sagte',
    ...
    annahmeRisiko: 'Risikoneigung: Eskalation treibt Kapital in sichere Häfen und belastet Krypto und Aktien, Entspannung wirkt umgekehrt. Der Zinskanal spielt hier keine Rolle.',
  ...
  en: {
    ...
    sortOpt: { eingang: 'Arrival', priority: 'Relevance', time: 'Time', impact: 'Signal strength' },
    ...
    frageOhneWorker: 'Asking requires the Cloudflare Worker with a key set.',
    frageDu: 'You', frageModell: 'Answer',
    zustand: 'SYSTEM STATUS', zustandPruefen: 'Check status',
    ...
    eingang: 'in',
    eingangHinweis: 'Left: when the source published it. Right: when it reached us — the time of the Discord alert.',
    ...
    liveHinweis: 'Address of the Cloudflare Worker. Leave empty for the default cadence. The pass phrase protects the subscription and quota — it must match the one set in the worker.',
    zugangPlatzhalter: 'Pass phrase (protects subscription and quota)', liveInaktiv: 'Default cadence (GitHub Actions)',
    ...
    kiKorrigiert: 'corrected by AI analysis',
    regelSagte: 'rules said',
    ...
    annahmeRisiko: 'Risk appetite: escalation drives capital into safe havens and weighs on crypto and equities; de-escalation works the other way. The rate channel does not apply here.',
